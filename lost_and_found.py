...
class Solution:
  def check_lost_and_found(self, lost_items: List[str], lost_and_found_pile: List[str]) -> List[str]:
   # TODO Implement this function
    return

solution = Solution()
print(solution.check_lost_and_found(lost_items, lost_and_found_pile))
